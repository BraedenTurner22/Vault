...
//  vault
//
//  Created by Braeden Turner on 11/8/25.
//

struct SVGs {
    static let vaultAnimated = """
    <svg fill="#ffffff" width="200" height="200" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
          @keyframes spin {
            0% { transform: rotate(0deg); }
            60% { transform: rotate(720deg); }
            65%, 100% { transform: rotate(720deg); }
          }
